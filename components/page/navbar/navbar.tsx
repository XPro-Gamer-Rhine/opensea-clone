...
import Connected from '../../wagmi/connected';
  ...
  return (
    <header className="fixed top-0 z-20 w-full transition-colors js-page-header backdrop-blur">
      <div className="flex items-center px-6 py-6 xl:px-24">
        ...
        <div
          className={
            'js-mobile-menu dark:bg-jacarta-800  fixed inset-0 z-20 ml-auto items-center bg-white opacity-0 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent' +
            (navbarOpen ? ' nav-menu--is-open' : ' hidden invisible')
          }
        >
          <div
            className={
              ' left-0 flex items-center justify-between w-full p-6 bg-white t-0 dark:bg-jacarta-800 lg:hidden' +
              (navbarOpen
                ? ' fixed z-20 dark:bg-violet-700 bg-violet-600'
                : ' ')
            }
          >
            <a href="index.html" className="shrink-0">
          ...
          >
            <input
              type="search"
              className="text-jacarta-700 opacity-60 placeholder-jacarta-500 focus:ring-accent border-jacarta-100 w-full rounded-2xl border py-3 px-4 pl-10 dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white"
              placeholder="Search"
            />
            <span className="absolute top-0 left-0 flex items-center justify-center w-12 h-full rounded-2xl">
              <svg
              ...
              <li className="relative js-nav-dropdown group">
                ...
                >
                  <li>
                    <a
                      href="index.html"
                      className="flex items-center px-5 py-2 transition-colors dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 rounded-xl"
                    >
          ...
          <div className="hidden ml-8 lg:flex xl:ml-12">
            ...
            <div className="border-jacarta-100 hover:bg-accent focus:bg-accent group dark:hover:bg-accent js-dark-mode-trigger ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]">
              <DarkMode />
            </div>
          </div>
        </div>
        <div className="flex ml-auto lg:hidden">
          <a
            href="edit-profile.html"
            className={
              ' border-jacarta-100 hover:bg-accent focus:bg-accent group dark:hover:bg-accent ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]' +
              (navbarOpen ? ' hidden invisible' : ' ')
            }
            aria-label="profile"
          >
            <svg
              ...
              width={24}
              height={24}
              className="w-4 h-4 transition-colors fill-black group-hover:fill-white group-focus:fill-white dark:fill-white"
            >
              <path fill="none" d="M0 0h24v24H0z" />
          ...
          <div
            className={
              'border-jacarta-100 hover:bg-accent dark:hover:bg-accent focus:bg-accent group ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]' +
              (navbarOpen ? ' hidden invisible' : ' visible')
            }
          >
            <DarkMode />
          </div>
          <button
            className={
              'js-mobile-toggle border-jacarta-100 hover:bg-accent dark:hover:bg-accent focus:bg-accent group ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]' +
              (navbarOpen ? ' hidden invisible' : ' ')
            }
